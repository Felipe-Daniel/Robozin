 ...
 */
package robozin.recommenders.internal.jayes.util;
...
public final class AddressCalc {
    ...
    /**
     * computes a mapping from the factors' addresses to the corresponding index of
     * the flat value array of a factor
     * consisting of the dimensions with the given dimensionIDs. dimensionIDs is
     * expected to be a superset of the
