 ...
 ******************************************************************************/
package robozin.recommenders.jayes.util.sharing;
...
/**
 * Set to support managing canonical, shared instances. These instances should
 * be
 * immutable while in the set. Call get(T) to get a canonical instance for the
 * specified
 * key.
 *
 * @param <T>
