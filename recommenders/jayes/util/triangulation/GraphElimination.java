...
/**
 * Graph elimination based on greedy minimum fill-in heuristic. Tie-breaking is
 * done by using weights on the nodes. On
 * tie, the node is chosen that will result in the cluster with a minimal sum of
 * node weights
 */
