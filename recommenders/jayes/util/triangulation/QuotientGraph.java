 ...
 ******************************************************************************/
package robozin.recommenders.jayes.util.triangulation;
...
/**
 * Quotient graphs are special data structures for the perfect elimination order
 * problem. Their size stays in O(|E|)
 * where E is the set of edges. Using plain graphs would result in a storage
 * complexity of O(|E*|), where E* is the set
