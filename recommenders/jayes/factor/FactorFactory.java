...
import robozin.recommenders.jayes.factor.arraywrapper.FloatArrayWrapper;
...
public class FactorFactory {
     ...
     * 
     * @param contentType
     *                    possible values: double.class, Double.class, float.class,
     *                    Float.class
     */
    ...
    /**
     * using logarithmic values for computation is a lot slower, but also a lot more
     * numerically stable
     */
    ...
    /**
     * creates a factor, the class of which is dependent on different criteria
     * defined in the concrete subclasses. The
