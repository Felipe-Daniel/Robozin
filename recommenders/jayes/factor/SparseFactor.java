 ...
 */
package robozin.recommenders.jayes.factor;

import java.util.Arrays;
import java.util.Comparator;

import robozin.recommenders.internal.jayes.util.AddressCalc;
...
import robozin.recommenders.jayes.factor.opcache.DivisionCache;
...
public class SparseFactor extends AbstractFactor {
    ...
    public void copyValues(IArrayWrapper other) {
        ...
        // we don't know how many values need to be copied, thus copy everything until
        // the end
     ...
     * according to the zero/non-zero
     * structure of the factors that will be multiplied in. This method should
     * <strong>always</strong> and
     * <strong>only</strong> be called <strong>once before</strong> any call that
     * modifies this factor's values
     * 
     * @param compatible
     *                   a Factor with compatible dimensions
     */
    /*
     * can't put this in a constructor because we already need full information
     * about the dimensions here
     */
     ...
     * 
     * @param futureLength
     *                                 the length that the new factor's value array
     *                                 would have in a dense factor
