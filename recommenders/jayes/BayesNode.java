 ...
 */
package robozin.recommenders.jayes;
...
import robozin.recommenders.internal.jayes.util.BidirectionalMap;
import robozin.recommenders.jayes.factor.AbstractFactor;
import robozin.recommenders.jayes.factor.DenseFactor;
...
public class BayesNode {
    ...
    /**
     * @deprecated use {@link BayesNet#createNode(String) BayesNet.createNode}
     *             instead
     */
    @Deprecated
    ...
    /**
     * Must be called after the parents and outcomes, and the outcome of the parents
     * are set.
     */
