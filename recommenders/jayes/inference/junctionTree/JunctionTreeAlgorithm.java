 ...
 */
package robozin.recommenders.jayes.inference.junctionTree;

import static robozin.recommenders.jayes.util.Pair.newPair;
...
import robozin.recommenders.internal.jayes.util.ArrayUtils;
import robozin.recommenders.jayes.BayesNet;
import robozin.recommenders.jayes.BayesNode;
import robozin.recommenders.jayes.factor.AbstractFactor;
import robozin.recommenders.jayes.factor.arraywrapper.DoubleArrayWrapper;
import robozin.recommenders.jayes.factor.arraywrapper.IArrayWrapper;
import robozin.recommenders.jayes.inference.AbstractInferer;
import robozin.recommenders.jayes.util.Graph;
import robozin.recommenders.jayes.util.Graph.Edge;
import robozin.recommenders.jayes.util.MathUtils;
import robozin.recommenders.jayes.util.NumericalInstabilityException;
import robozin.recommenders.jayes.util.Pair;
import robozin.recommenders.jayes.util.sharing.CanonicalArrayWrapperManager;
import robozin.recommenders.jayes.util.sharing.CanonicalIntArrayManager;
import robozin.recommenders.jayes.util.triangulation.MinFillIn;
...
public class JunctionTreeAlgorithm extends AbstractInferer {
    ...
    /**
     * checks which nodes need not be processed during collectEvidence (because of
     * preprocessing). These are those nodes
    ...
    /**
     * checks which nodes do not need to be visited during evidence distribution.
     * These are exactly those nodes which
     * are
     * <ul>
