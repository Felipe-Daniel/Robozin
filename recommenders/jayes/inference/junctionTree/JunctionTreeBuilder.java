...
import robozin.recommenders.internal.jayes.util.UnionFind;
...
import robozin.recommenders.jayes.util.triangulation.GraphElimination;
import robozin.recommenders.jayes.util.triangulation.IEliminationHeuristic;
...
public class JunctionTreeBuilder {
    ...
    private double[] weightNodesByOutcomes(BayesNet net) {
        ...
        for (BayesNode node : net.getNodes()) {
            ...
            // using these weights is the same as minimizing the resulting cluster factor
            // size
    ...
    private boolean containsSuperset(final Collection<? extends Collection<Integer>> sets,
